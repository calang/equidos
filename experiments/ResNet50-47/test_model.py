...
This script evaluates the model on all images in data/THGtest, compares
...
def main():
    ...
    parser.add_argument(
        '--test-dir',
        type=str,
        default='data/THGtest',
        help='Path to test data directory (default: data/THGtest)'
    )
    parser.add_argument(
        '--model',
        type=str,
    ...
    parser.add_argument(
        '--output',
        type=str,
        default='experiments/ResNet50-47/test_results.csv',
        help='Output file path (default: experiments/ResNet50-47/test_results.csv)'
    )
