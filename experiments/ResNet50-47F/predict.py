...
def main():
    ...
    parser.add_argument('--model', type=str, default='experiments/ResNet50-47F/models/best_model.pth',
                        help='Path to the model file (default: experiments/ResNet50-47F/models/best_model.pth)')
